          ...
          <v-card class="py-4 px-4 rounded" hover> <!-- TODO: Add rounded corners -->
            ...
            <span style="color: red;">{{info}}</span>
              ...
              <v-card-text class="py-0 px-2 grey--text">
                Verantwortlich für dieses Fach: <a :href="'mailto:'+e+'@ethz.ch'" v-for="(e, index) in editors" v-bind:key="e.id"><span v-if="index < editors.length && index > 0 && e != null">, </span>{{e}}</a>
              </v-card-text>
              <br>
              <v-card-actions>
